...
class CourseUpdateTest(CourseTestCase):
    ...
    @patch("contentstore.course_info_model.push_notification")
    def test_post_course_update(self, mock_push_notification):
        """
        ...
        self.assertFalse(mock_push_notification.delay.called)
    ...
    @patch("contentstore.course_info_model.push_notification")
    def test_notifications_enabled_but_not_requested(self, mock_push_notification):
        MobileNotificationsConfig(enabled=True).save()
        self.post_course_update()
        self.assertFalse(mock_push_notification.delay.called)

    @patch("contentstore.course_info_model.push_notification")
    def test_notifications_sent(self, mock_push_notification=False):
        MobileNotificationsConfig(enabled=True).save()
        self.post_course_update(send_push_notification=True)
        self.assertTrue(mock_push_notification.delay.called)
